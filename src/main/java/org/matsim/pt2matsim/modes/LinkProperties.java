...
public class LinkProperties {
	...
	public static final int LEVEL_PRESERVED = 16;
	public static final int LEVEL_TRAM = 17;
	public static final int LEVEL_SUBWAY = 18;
	public static final int LEVEL_LIGHT_RAIL = 19;
	public static final int LEVEL_RAIL = 20;
	public static final int LEVEL_HIGHSPEED = 21;
	...
	static LinkProperties createPreserved() {
		return new LinkProperties(LEVEL_PRESERVED, 1, 10 / 3.6, 300, false);
	}
	
	static LinkProperties createTram() {
	...
	static LinkProperties createLightRail() {
	...
	static LinkProperties createHighspeed() {
		return new LinkProperties(LEVEL_HIGHSPEED, 1, 10 / 3.6, 300, false);
	}
